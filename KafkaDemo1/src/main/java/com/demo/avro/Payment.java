...
public class Payment extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.demo.avro.Payment.Builder newBuilder() {
    return new com.demo.avro.Payment.Builder();
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.demo.avro.Payment.Builder newBuilder(com.demo.avro.Payment.Builder other) {
    if (other == null) {
      return new com.demo.avro.Payment.Builder();
    } else {
      return new com.demo.avro.Payment.Builder(other);
    }
  }
   ...
   * @return A new Payment RecordBuilder
   */
  public static com.demo.avro.Payment.Builder newBuilder(com.demo.avro.Payment other) {
    if (other == null) {
      return new com.demo.avro.Payment.Builder();
    } else {
      return new com.demo.avro.Payment.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Payment>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.demo.avro.Payment.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.demo.avro.Payment other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.Payment.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.Payment.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.Payment.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.demo.avro.Payment.Builder clearAmount() {
